 ...
 * @author nadee
 */
public class UpdateCustomerOrder extends javax.swing.JFrame {

    /**
     * Creates new form UpdateCustomerOrder
     */
    ...
    public UpdateCustomerOrder(String customer_id) {
        initComponents();
...
//                String id = AutoGenerateID.getNextID("CUSTOMER", "customer_id", "C", 5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCustomerOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCustomerOrder().setVisible(true);
            }
        });
    }
