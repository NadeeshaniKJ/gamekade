 ...
 * @author nadee
 */
public class SearchCustomerOrder extends javax.swing.JFrame {

    /**
     * Creates new form SearchCustomerOrder
     */
...
//    private int currentIndex = 0;
                    ...
                    jTbl_SearchCustomers.addMouseListener(new java.awt.event.MouseAdapter() {
                        ...
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                            ...
                            try {
                                ...
                                Logger.getLogger(SearchCustomerOrder.class.getName()).log(Level.SEVERE, null, ex);
                            }
                            // verifiction ends
                            // verifiction ends
                            // verifiction ends
                            ...
                            DeleteCustomerOrder Delete = new DeleteCustomerOrder(valueInCell);
    ...
    private void loadCombo() {
        try {
            ...
            Logger.getLogger(SearchCustomerOrder.class
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchCustomerOrder.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchCustomerOrder().setVisible(true);
