 ...
 * @author nadee
 */
public class SaveOrder extends javax.swing.JFrame {

    /**
     * Creates new form SaveOrder
     */
    public SaveOrder() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLbl_addNewCus.setText("ORDER DETAILS");

        jLbl_cusID.setText("Sub Total :");

        jLbl_cusName.setText("Total :");

        jLbl_cusNIC.setText("Payment :");

        jLbl_cusContactNum.setText("Balance :");
        ...
        jLbl_cusTitle.setText("Discount :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaveOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
