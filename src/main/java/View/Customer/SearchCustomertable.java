 ...
 * @author nadee
 */
public class SearchCustomertable extends javax.swing.JFrame {
...
//    private int currentIndex = 0;
    ...
    private void loadCombo() {
        try {
            ...
            Logger.getLogger(SearchCustomertable.class
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchCustomertable.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchCustomertable().setVisible(true);
